...
def upsample(img, is_flow, scale_factor=2.0, align_corners=True):
    img_resized = nn.functional.interpolate(
        img, scale_factor=scale_factor, mode="trilinear", align_corners=align_corners
    )
