...
from model.model import CONFIGS as CONFIGE_TM
from model.model import TransMorph
...
parser.add_argument("--max_epoch", type=int, default=50, help="最大轮数")
parser.add_argument(
...
parser.add_argument("--model", type=str, default="TransMorph", help="使用的模型名称")
parser.add_argument(
    "--train_dir",
    type=str,
