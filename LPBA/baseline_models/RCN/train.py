...
parser.add_argument(
    "--train_dir",
    type=str,
    default="/root/autodl-tmp/RDP_LPBA_data/Train/",
    help="训练集数据目录",
)
parser.add_argument(
    "--val_dir",
    type=str,
    default="/root/autodl-tmp/RDP_LPBA_data/Val/",
    help="验证集数据目录",
)
...
def main():
    ...
    train_set = datasets.LPBABrainDatasetS2S(
