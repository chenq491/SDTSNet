...
class VxmDense_1(nn.Module):
    ...
    def __init__(self,
        ...
        Conv = getattr(nn, 'Conv%dd' % ndims)
        self.flow = Conv(self.unet_model.dec_nf[-1],
                         ndims,
                         kernel_size=3,
                         padding=1)
...
class VxmDensex2(nn.Module):
    ...
    def __init__(self,
                 inshape,
                 nb_unet_features=((32, 64, 64, 64), (64, 64, 64, 64, 64, 32,
                                                      32)),
                 nb_unet_levels=None,
                 unet_feat_mult=1,
                 use_probs=False):
...
class VxmDense_huge(nn.Module):
    ...
    def __init__(self,
                 inshape,
                 nb_unet_features=((14, 28, 144, 320), (1152, 1152, 320, 144,
                                                        28, 14, 14)),
                 nb_unet_levels=None,
                 unet_feat_mult=1,
                 use_probs=False):
