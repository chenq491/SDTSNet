...
substruct_ids = {
    ...
    "Parietal": [1010, 1024, 1027, 1030, 2010, 2024, 2027, 2030],
    "Temporal": [
        1008,
        1009,
        1011,
    ...
    "Occipital": [1007, 1013, 1015, 1023, 2007, 2013, 2015, 2023],
    "Cingulate": [1005, 1012, 1025, 2005, 2012, 2025],
    "Insula": [1035, 2035],
}
methods = [
    "SDTSNet",
...
def compute_dice():
    ...
    加载数据集
    """
    test_dir = "/root/autodl-tmp/Mindboggle101/Test/"
